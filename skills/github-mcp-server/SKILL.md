...
| `actions` | GitHub Actions/CI/CD | `list_workflows`, `run_workflow`, `get_workflow_run`, `get_job_logs` |
...
- `get_workflow_run_usage` - Get usage metrics and billing information
...
- `delete_workflow_run_logs` - Delete workflow run logs (destructive operation)
...
| `list_workflows`, `list_workflow_runs`, `get_workflow_run`, `run_workflow` | `actions` |
